...
#ifndef RZ_RE_PRE_INIT_LISP__H
#define RZ_RE_PRE_INIT_LISP__H
...
class RE_Pre_Init_Lisp : public RE_Lisp_Output
{
public:

 RE_Pre_Init_Lisp(caon_ptr<RE_Document> document);

 virtual void output_from_node(QTextStream& qts,
  const RE_Node& node, int indent = 0,
  caon_ptr<RE_Call_Entry> rce_ptr = nullptr) override;
