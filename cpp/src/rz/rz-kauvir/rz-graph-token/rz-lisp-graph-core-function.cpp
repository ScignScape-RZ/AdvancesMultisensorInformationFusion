...
#include "rz-lisp-graph-core-function.h"


USING_RZNS(GBuild)


RZ_Lisp_Graph_Core_Function::RZ_Lisp_Graph_Core_Function
...
QMap<QString, QString> RZ_Lisp_Graph_Core_Function::out_pastes_
 {{{ "Generate_Clos", "(self -> generate-clos)" }}};


QString RZ_Lisp_Graph_Core_Function::get_out_name()
{
...
QString RZ_Lisp_Graph_Core_Function::get_out_name_or_string()
{
 if(flags.paste)
 {
