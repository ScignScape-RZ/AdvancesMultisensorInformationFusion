...
#ifndef RZ_LISP_GRAPH_CORE_FUNCTION__H
#define RZ_LISP_GRAPH_CORE_FUNCTION__H
...
public:
 ...
 RZ_Lisp_Graph_Core_Function(QString rz_name, QString name, int arity, Status_Codes sc);
...
#endif //RZ_LISP_GRAPH_CORE_FUNCTION__H
